...
heatmaply::heatmaply(cordat, main="ALL", xlab="Genes", ylab="Subjects", col=c("black","red"),  row_side_palette= NCcol, labRow = NULL, show_dendrogram = c(FALSE, FALSE),hide_colorbar=FALSE,  dpi=600)
