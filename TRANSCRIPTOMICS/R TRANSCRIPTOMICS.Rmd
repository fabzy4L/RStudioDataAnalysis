...
data = read.csv(text = getURL('https://raw.githubusercontent.com/fabzy4L/RStudioDataAnalysis/Main/TRANSCRIPTOMICS/rma-sketch.summary.txt'), sep = "\t", stringsAsFactors = TRUE)
```
